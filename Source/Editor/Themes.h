...
namespace won
{
	namespace editor::theme
	{
		...
		inline const float4 terrain_spline_color = { 0.25f, 0.78f, 1.0f, 1.0f };
		inline const float4 terrain_spline_width_color = { 0.25f, 0.78f, 1.0f, 0.65f };
		inline const float4 terrain_spline_falloff_color = { 0.25f, 0.78f, 1.0f, 0.32f };
		inline const float4 terrain_spline_point_color = { 0.90f, 0.90f, 0.90f, 1.0f };
		inline const float4 terrain_spline_selected_point_color = { 1.0f, 0.72f, 0.20f, 1.0f };
