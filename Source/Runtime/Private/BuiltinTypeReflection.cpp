...
namespace won::reflection
{
    void RegisterBuiltinTypes()
    {
        ...
        RegisterType(TypeMeta<rendering::AmbientOcclusionMode>::Get());
        ...
        RegisterType(TypeMeta<ecs::FoliageCollisionMode>::Get());
        RegisterType(TypeMeta<ecs::FoliageInstance>::Get());
        RegisterType(TypeMeta<ecs::FoliageType>::Get());
        RegisterType(TypeMeta<ecs::FoliageComponent>::Get());
