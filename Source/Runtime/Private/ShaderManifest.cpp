...
namespace won::resource
{
    const ShaderManifest& GetDefaultShaderManifest()
    {
        static const ShaderManifest manifest = {
            ...
            { ShaderId::VSObjectMotion, { rendering::RHIShaderStage::Vertex, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectVS_motion.hlsl", "main" } },
            { ShaderId::VSObjectMotionMasked, { rendering::RHIShaderStage::Vertex, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectVS_motion_masked.hlsl", "main" } },
            { ShaderId::VSObjectMotionNormal, { rendering::RHIShaderStage::Vertex, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectVS_motion_normal.hlsl", "main" } },
            { ShaderId::VSObjectMotionNormalMasked, { rendering::RHIShaderStage::Vertex, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectVS_motion_normal_masked.hlsl", "main" } },
            ...
            { ShaderId::PSObjectNormal, { rendering::RHIShaderStage::Pixel, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectPS_normal.hlsl", "main" } },
            { ShaderId::PSObjectMotion, { rendering::RHIShaderStage::Pixel, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectPS_motion.hlsl", "main" } },
            { ShaderId::PSObjectMotionMasked, { rendering::RHIShaderStage::Pixel, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectPS_motion_masked.hlsl", "main" } },
            { ShaderId::PSObjectMotionNormal, { rendering::RHIShaderStage::Pixel, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectPS_motion_normal.hlsl", "main" } },
            { ShaderId::PSObjectMotionNormalMasked, { rendering::RHIShaderStage::Pixel, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectPS_motion_normal_masked.hlsl", "main" } },
