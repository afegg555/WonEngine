...
namespace won::resource
{
    const ShaderManifest& GetDefaultShaderManifest()
    {
        static const ShaderManifest manifest = {
            ...
            { ShaderId::VSSprite3D, { rendering::RHIShaderStage::Vertex, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "SpriteVS.hlsl", "main" } },
            ...
            { ShaderId::PSObjectSprite, { rendering::RHIShaderStage::Pixel, ShaderFormat::HLSL6, ShaderModel::SM_6_0, "ObjectPS_sprite.hlsl", "main" } },
