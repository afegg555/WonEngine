...
namespace won::reflection
{
    ...
    WON_REFLECT_STRUCT(won::ecs::WaterBodyComponent, "WaterBodyComponent")
        ...
        WON_REFLECT_FIELD(wave_frequency, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(normal_strength, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_velocity_primary, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_velocity_secondary, won::FieldFlagEditable | won::FieldFlagSerializable)
