...
namespace won::reflection
{
    ...
    WON_REFLECT_ENUM(won::rendering::ViewMode, "ViewMode")
        ...
        WON_REFLECT_ENUM_VALUE("BaseColor", won::rendering::ViewMode::BaseColor)
        WON_REFLECT_ENUM_VALUE("WorldNormal", won::rendering::ViewMode::WorldNormal)
        WON_REFLECT_ENUM_VALUE("Roughness", won::rendering::ViewMode::Roughness)
        WON_REFLECT_ENUM_VALUE("Metallic", won::rendering::ViewMode::Metallic)
        WON_REFLECT_ENUM_VALUE("LightComplexity", won::rendering::ViewMode::LightComplexity)
    ...
    WON_REFLECT_ENUM(won::ecs::SoftBodyComponent::AttachmentMode, "SoftBodyAttachmentMode")
        WON_REFLECT_ENUM_VALUE("None", won::ecs::SoftBodyComponent::AttachmentMode::None)
        WON_REFLECT_ENUM_VALUE("TopRow", won::ecs::SoftBodyComponent::AttachmentMode::TopRow)
        WON_REFLECT_ENUM_VALUE("TopCorners", won::ecs::SoftBodyComponent::AttachmentMode::TopCorners)
    WON_REFLECT_ENUM_END()

    WON_REFLECT_ENUM(won::ecs::SoftBodyComponent::BendType, "SoftBodyBendType")
        WON_REFLECT_ENUM_VALUE("None", won::ecs::SoftBodyComponent::BendType::None)
        WON_REFLECT_ENUM_VALUE("Distance", won::ecs::SoftBodyComponent::BendType::Distance)
        WON_REFLECT_ENUM_VALUE("Dihedral", won::ecs::SoftBodyComponent::BendType::Dihedral)
    WON_REFLECT_ENUM_END()

    WON_REFLECT_ENUM(won::ecs::SoftBodyComponent::LRAType, "SoftBodyLRAType")
        WON_REFLECT_ENUM_VALUE("None", won::ecs::SoftBodyComponent::LRAType::None)
        WON_REFLECT_ENUM_VALUE("EuclideanDistance", won::ecs::SoftBodyComponent::LRAType::EuclideanDistance)
        WON_REFLECT_ENUM_VALUE("GeodesicDistance", won::ecs::SoftBodyComponent::LRAType::GeodesicDistance)
    WON_REFLECT_ENUM_END()
    ...
    WON_REFLECT_STRUCT(won::ecs::EnvironmentComponent, "EnvironmentComponent")
        ...
        WON_REFLECT_FIELD(cloud_density, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(cloud_frequency, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(cloud_speed, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(cloud_color, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(cloud_direction, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wind_direction, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wind_speed, won::FieldFlagEditable | won::FieldFlagSerializable)
    ...
    WON_REFLECT_ENUM(won::ecs::WaterZoneComponent::Flags, "WaterZoneFlags")
        WON_REFLECT_ENUM_VALUE("Active", won::ecs::WaterZoneComponent::Active)
    WON_REFLECT_ENUM_END()

    WON_REFLECT_STRUCT(won::ecs::WaterZoneComponent, "WaterZoneComponent")
        WON_REFLECT_FLAGS_FIELD(flags, won::FieldFlagEditable | won::FieldFlagSerializable, won::ecs::WaterZoneComponent::Flags)
        WON_REFLECT_FIELD(half_extent, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(info_resolution, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(ripple_resolution, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(ripple_speed, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(ripple_radius, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(tile_resolution, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(lod_levels, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(lod_distance_scale, won::FieldFlagEditable | won::FieldFlagSerializable)
    WON_REFLECT_STRUCT_END()

    WON_REFLECT_ENUM(won::ecs::WaterBodyComponent::Type, "WaterBodyType")
        WON_REFLECT_ENUM_VALUE("Lake", won::ecs::WaterBodyComponent::Type::Lake)
    WON_REFLECT_ENUM_END()

    WON_REFLECT_ENUM(won::ecs::WaterBodyComponent::Flags, "WaterFlags")
        WON_REFLECT_ENUM_VALUE("Active", won::ecs::WaterBodyComponent::Active)
        WON_REFLECT_ENUM_VALUE("ReceiveShadow", won::ecs::WaterBodyComponent::ReceiveShadow)
    WON_REFLECT_ENUM_END()

    WON_REFLECT_STRUCT(won::ecs::WaterBodyComponent, "WaterBodyComponent")
        WON_REFLECT_FLAGS_FIELD(flags, won::FieldFlagEditable | won::FieldFlagSerializable, won::ecs::WaterBodyComponent::Flags)
        WON_REFLECT_FIELD(type, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(half_extent, won::FieldFlagEditable | won::FieldFlagSerializable)
        ...
        WON_REFLECT_FIELD(detail_frequency, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(detail_strength, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(detail_velocity_primary, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(detail_velocity_secondary, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_count, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_length, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_amplitude, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_steepness, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_direction, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wave_direction_spread, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(refraction_strength, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(roughness, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(reflectance, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(ripple_strength, won::FieldFlagEditable | won::FieldFlagSerializable)
    WON_REFLECT_STRUCT_END()
    ...
    WON_REFLECT_STRUCT(won::ecs::Rigidbody3DComponent, "Rigidbody3DComponent")
        ...
        WON_REFLECT_FIELD(center_of_mass_offset, won::FieldFlagEditable | won::FieldFlagSerializable)
    ...
    WON_REFLECT_STRUCT(won::ecs::SoftBodyComponent, "SoftBodyComponent")
        WON_REFLECT_FIELD(flags, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(attachment_mode, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(divisions_x, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(divisions_y, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(size_x, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(size_y, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(mass, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(edge_compliance, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(shear_compliance, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(bend_compliance, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(bend_type, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(lra_type, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(lra_max_distance_multiplier, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(linear_damping, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(friction, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(restitution, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(solver_iterations, won::FieldFlagEditable | won::FieldFlagSerializable)
    WON_REFLECT_STRUCT_END()

    WON_REFLECT_ENUM(won::ecs::VehiclePreset, "VehiclePreset")
        WON_REFLECT_ENUM_VALUE("Sedan", won::ecs::VehiclePreset::Sedan)
        WON_REFLECT_ENUM_VALUE("Sports", won::ecs::VehiclePreset::Sports)
        WON_REFLECT_ENUM_VALUE("Offroad", won::ecs::VehiclePreset::Offroad)
    WON_REFLECT_ENUM_END()

    WON_REFLECT_STRUCT(won::ecs::VehicleWheel, "VehicleWheel")
        WON_REFLECT_FIELD(attachment_position, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(radius, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(width, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(suspension_min_length, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(suspension_max_length, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(suspension_frequency, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(suspension_damping, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(max_steer_angle_radians, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(max_brake_torque, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(max_hand_brake_torque, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(driven, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(visual_entity, won::FieldFlagEditable | won::FieldFlagSerializable | won::FieldFlagEntityRef)
    WON_REFLECT_STRUCT_END()

    WON_REFLECT_STRUCT(won::ecs::VehicleComponent, "VehicleComponent")
        WON_REFLECT_FIELD(flags, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(wheels, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(up, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(forward, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(max_pitch_roll_angle_radians, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(engine_max_torque, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(engine_min_rpm, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(engine_max_rpm, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(differential_ratio, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(forward_gear_ratios, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(reverse_gear_ratios, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(shift_up_rpm, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(shift_down_rpm, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(shift_duration, won::FieldFlagEditable | won::FieldFlagSerializable)
    WON_REFLECT_STRUCT_END()
    ...
    WON_REFLECT_STRUCT(won::ecs::TerrainComponent, "TerrainComponent")
        WON_REFLECT_FIELD(terrain_data_path, won::FieldFlagSerializable)
    WON_REFLECT_STRUCT_END()

    WON_REFLECT_ENUM(won::ecs::FoliageCollisionMode, "FoliageCollisionMode")
        WON_REFLECT_ENUM_VALUE("None", won::ecs::FoliageCollisionMode::None)
        WON_REFLECT_ENUM_VALUE("Trunk", won::ecs::FoliageCollisionMode::Trunk)
    WON_REFLECT_ENUM_END()

    WON_REFLECT_STRUCT(won::ecs::FoliageInstance, "FoliageInstance")
        WON_REFLECT_FIELD(position, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(scale, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(rotation, won::FieldFlagSerializable)
    WON_REFLECT_STRUCT_END()

    WON_REFLECT_STRUCT(won::ecs::FoliageType, "FoliageType")
        WON_REFLECT_FIELD(mesh_asset_path, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(material_asset_path, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(density, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(scale_range, won::FieldFlagEditable | won::FieldFlagSerializable)
        ...
        WON_REFLECT_FIELD(slope_max_degrees, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(height_min, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(height_max, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(terrain_layer, won::FieldFlagEditable | won::FieldFlagSerializable)
    ...
    WON_REFLECT_STRUCT(won::ecs::FoliageComponent, "FoliageComponent")
        WON_REFLECT_FIELD(flags, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(types, won::FieldFlagSerializable)
        WON_REFLECT_FIELD(region_center, won::FieldFlagEditable | won::FieldFlagSerializable)
        WON_REFLECT_FIELD(region_extent, won::FieldFlagEditable | won::FieldFlagSerializable)
