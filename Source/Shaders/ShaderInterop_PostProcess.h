...
#ifdef __cplusplus
static_assert(sizeof(TonemapConstants) == 20, "TonemapConstants layout mismatch");
#endif

#ifdef WON_TONEMAP_CONSTANTBUFFER
CONSTANTBUFFER(tonemapcb, TonemapConstants, CBSLOT_RENDERER_PASS);
#endif
...
struct LuminanceReduceConstants
{
...
CONSTANTBUFFER(luminancereducecb, LuminanceReduceConstants, CBSLOT_RENDERER_PASS);
#endif
...
#ifdef __cplusplus
static_assert(sizeof(SkyPrefilterPushConstants) == 12, "SkyPrefilterPushConstants layout mismatch");
#endif
