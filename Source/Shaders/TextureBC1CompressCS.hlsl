...
void main(uint3 dispatch_thread_id : SV_DispatchThreadID)
{
    ...
    const uint2 compressed_block = CompressBlockBC1_UNORM(block_rgb, GetBCCompressQuality(), IsBCCompressSRGB());
    StoreBCBlock2(GetBCBlockIndex(block_id), compressed_block);
}
